...
func newInternal(rootSDK *Mix, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Internal {
	return &Internal{
		rootSDK:          rootSDK,
...
func (s *Internal) RefreshOAuthTokens(ctx context.Context, opts ...operations.Option) (*operations.RefreshOAuthTokensResponse, error) {
