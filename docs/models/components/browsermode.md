...
| Name                                 | Value                                |
| ------------------------------------ | ------------------------------------ |
| `BrowserModeElectronEmbeddedBrowser` | electron-embedded-browser            |
| `BrowserModeLocalBrowserService`     | local-browser-service                |
| `BrowserModeRemoteCdpWebsocket`      | remote-cdp-websocket                 |