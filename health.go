...
func newHealth(rootSDK *Mix, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Health {
	return &Health{
		rootSDK:          rootSDK,
...
func (s *Health) GetOAuthHealth(ctx context.Context, opts ...operations.Option) (*operations.GetOAuthHealthResponse, error) {
